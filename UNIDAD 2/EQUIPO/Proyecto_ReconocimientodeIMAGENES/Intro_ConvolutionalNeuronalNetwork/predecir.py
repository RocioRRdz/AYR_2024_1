...
def probar_red_neuronal():
    base_location = '../Intro_ConvolutionalNeuronalNetwork/F3-Prueba/'
    ...
    for folder in folders:
        files = [archivo for archivo in os.listdir(base_location + '/' + folder) if archivo.endswith(".png") or archivo.endswith(".png") or archivo.endswith(".png")]
        for file in files:
